...
var BASE_URL    = "http://api.iqengines.com/v1.2",
    ...
    ADD_IMG_URL  = BASE_URL + "/object/:id/images";
...
var Api = (function(){
    ...
    cls.prototype._signedRequest = function (args, callback) {
        var d = { url: null, method: null , fields: null, files: null },
    ...
    cls.prototype.createObject =function(args, callback){
        var d = { name : null, images : null, meta : null , collection : null, custom_id : null , json : true},
            args = U.defaults(d,args),                        
            fields = [],
            files  = [],
            callback = callback || function(res){},
        ...
        args.images.forEach(function(img, index){
    ...
    cls.prototype.updateObject = function(args, callback){        
        var d = { obj_id : null , images : null, json : true},
            args = U.defaults(d,args),                        
            fields = [],
            files  = [],
            callback = callback || function(res){},
        ...
        fields = U.select(U.items(args), function(i){ return i[1] != null && i[1] !== false;});
        this._signedRequest({
            url: ADD_IMG_URL.replace(':id',args.obj_id),
            method: "POST",
            fields: fields,
            files: files
        }, cb);        
    ...
    cls.prototype.getObject = function(args, callback){
        var d = { obj_id : null, json : true},
            args = U.defaults(d,args),                        
            fields = [],
            files  = [],
            callback = callback || function(res){},
    ...
    cls.prototype.delObject = function(args, callback){
        var d = { obj_id : null, json : true},
            args = U.defaults(d,args),                        
            fields = [],
            files  = [],
